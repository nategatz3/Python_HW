...
print(f'Hello, my name is {first_name} {last_name} and I am {my_age} years old.')
...
myiterablearray = [12, 'hello', True, 4.5]
...
print(f'Here is the flipped number: {reverse(x)}')
...
car_brands = ["Lincoln","Mercedes","Tesla"]
bills = ["electric","internet","rent","cable"]
pets = ["Talvi","Luigi","Ahri","Bella"]
electronics = ["TV","computer","gaming console","fridge"]

my_order = {"McDonalds": "Chicken Nuggets", "Culvers": "Butter Burger"}
fav_dog_toy = {"Luigi": "Tennis Ball", "Bella": "Tug-Rope"} #Yes, Luigi is the one that ate the ball.
family = {"Nathan": 23, "Sanna": 20, "Nick": 21}
our_vehicles = {"Nathan": "Lincoln", "Sanna": "Tesla", "Nick": "Mercedes"}
favorite_sports = {"Nathan": "Soccer", "Sanna": "Football"}
